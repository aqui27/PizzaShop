       ...
       <div class="main-panel">
          <div class="content-wrapper">
			...
			<div class="div_design">
          		...
          		<input class="text-color" type="number" name="discount_price" placeholder="Write a discount is apply" value="{{$product->discount_price}}">
          	</div>

			<div class="div_design">
          		<label>Product Quantity</label>
          		<input class="text-color" type="number" min="0" name="quantity" placeholder="Write a quantity" required="" value="{{$product->quantity}}">
          	</div>
